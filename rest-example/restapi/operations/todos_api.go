...
import (
	...
	"p2p/rest-example/restapi/operations/todos"
)

// NewTodosAPI creates a new Todos instance
func NewTodosAPI(spec *loads.Document) *TodosAPI {
	return &TodosAPI{
...
/*TodosAPI A draft to p2p rest API specification */
...
func (o *TodosAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *TodosAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *TodosAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *TodosAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *TodosAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *TodosAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *TodosAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the TodosAPI
func (o *TodosAPI) Validate() error {
...
func (o *TodosAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *TodosAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *TodosAPI) Authorizer() runtime.Authorizer {
...
func (o *TodosAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *TodosAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *TodosAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the todos API
func (o *TodosAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *TodosAPI) initHandlerCache() {
...
func (o *TodosAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
