...
//go:generate swagger generate server --target .. --name Todos --spec ../swagger.yml

func configureFlags(api *operations.TodosAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.TodosAPI) http.Handler {
